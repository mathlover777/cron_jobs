...
def send_reminder(email_id,thread,subject,auto_ask,msg_id):
	...
	sender_subject = "Planck Reminder for - " + first_name_list + ":" + subject
	sender_body = "Hi, this is to remind you that you have to take followup from " + first_name_list + " regarding " + subject
